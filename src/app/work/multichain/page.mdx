import logo from '@/images/clients/multichain/logomark-dark.svg'

export const caseStudy = {
  client: 'Multichain',
  title: 'Community driven growth initiatives',
  description:
    'Disruptiv3 assisted MultiDAO in composing and disseminating articles on advanced bridge technologies, advocating for governance initiatives in Multichain technology. We also represented MultiDAO at conferences, fostering partnerships and serving as a trusted point of contact for potential collaborators.',
  summary: [
    'Disruptiv3 assisted MultiDAO in composing and disseminating articles on advanced bridge technologies, advocating for governance initiatives in Multichain technology. We also represented MultiDAO at conferences, fostering partnerships and serving as a trusted point of contact for potential collaborators.',
    'Disruptiv3 assisted MultiDAO in composing and disseminating articles on advanced bridge technologies, advocating for governance initiatives in Multichain technology. We also represented MultiDAO at conferences, fostering partnerships and serving as a trusted point of contact for potential collaborators.',
  ],
...
<Blockquote author={{ name: 'Jenny Wilson', role: 'CPO of Phobia' }}>
