import logo from '@/images/clients/cube-commons/logomark-dark.svg'

export const caseStudy = {
  client: 'CubeCommons DAO',
  title: 'Bringing digital art to the forefront',
  description:
    'At CubeCommons, Disruptiv3 played a key role in developing a comprehensive full-stack infrastructure supporting the development of the DAO and continues to foster an open, collaborative environment for contributors.',
  summary: [
    'At CubeCommons, Disruptiv3 played a key role in developing a comprehensive full-stack infrastructure supporting the development of the DAO and continues to foster an open, collaborative environment for contributors.',
    'At CubeCommons, Disruptiv3 played a key role in developing a comprehensive full-stack infrastructure supporting the development of the DAO and continues to foster an open, collaborative environment for contributors.',
  ],
